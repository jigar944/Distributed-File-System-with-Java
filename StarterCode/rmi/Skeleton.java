...
public class Skeleton<T>
{
        ...
        try {
            if (address==null){
                ...
                while(true){
                    ...
                    //findFreePort returns the random 4-digit number.
                    int port = findFreePort();

                    // is Available function checks that port number assigned by findFreePort is available in system or not
                    if (isAvailable(port)){
    ...
    /**
     *
     * @param portNr 4 digit random number generated by findFreePort function.
     * @return <code>true</code> if port is free in system
     *          <code>false</code> if port is not available.
     */
    ...
    //multithreaded skeleton server which is able to attend multiple client requests
